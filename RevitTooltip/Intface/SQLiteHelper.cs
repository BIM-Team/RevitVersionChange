...
//                Dictionary<string, int> CurrentTableColumns = InsertIntoFrameType(sheetInfo.KeyNames, IdType);

//                //插入到EntityTable表，并返回新插入的实体数据的键值对<实体名,ID>
//                Dictionary<string, int> UpdateEntities = InsertIntoEntityTable(sheetInfo.EntityNames, IdType);
...
//                DeleteCurrentEntity(sheetInfo.EntityNames, InsertIntoTypeTable(sheetInfo));
...
//            int IdFrame;
//            int IdEntity;
//            int count = sheetInfo.KeyNames.Count;
...
//                        {
//                            IdFrame = CurrentTableColumns[sheetInfo.KeyNames.ElementAt(i)];
//                            if (n % 500 == 0)
//                            {
//                                if (n > 0)
