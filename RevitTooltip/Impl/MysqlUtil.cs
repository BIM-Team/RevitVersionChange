...
namespace Revit.Addin.RevitTooltip.Impl
{
    public class MysqlUtil : IDisposable, IMysqlUtil
    {
        ...
        {
            this.conn = new MySqlConnection("server="+settings.DfServer+
        ...
        private MysqlUtil()
        {
           this.conn = new MySqlConnection("server= 127.0.0.1 ;user= root; database= hzj ;port= 3306;password= root;charset= utf8");  //实例化连接          
        }
        /// <summary>
        /// 查看数据库能否链接
        /// </summary>
